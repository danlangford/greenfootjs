// copied from coffeescript source - look for //DBL annotations
...
(function() {
  ...
  optparse = require('./node_modules/coffee-script/lib/coffee-script/./optparse');
  ...
  exports.run = function(args) {
    ...
    if (opts.interactive) {
      return require('./node_modules/coffee-script/lib/coffee-script/./repl');
    }
  ...
  parseOptions = function() {
    ...
    o = opts = optionParser.parse(exports.injectArgs||process.argv.slice(2)); //DBL
    console.log('opts',opts); //DBL
    console.log(o.compile);
